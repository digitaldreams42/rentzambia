...
const PropertyImageGallery = React.forwardRef<HTMLDivElement, PropertyImageGalleryProps>(
  ({ images, className }, ref) => {
    const [currentImageIndex, setCurrentImageIndex] = React.useState(0);

    return (
      <Card ref={ref} className={cn("rounded-lg shadow-md overflow-hidden mb-6", className)}>
