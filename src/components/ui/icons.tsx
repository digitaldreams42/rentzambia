export const Icons = {
  ...
  google: (props: React.SVGProps<SVGSVGElement>) => (
    <svg
      ...
      {...props}
    >
      <path d="M21.8 10.5H12v3.5h5.6c-.3 1.7-1.5 3.2-3.2 4.1l2.5 2c1.5-1.4 2.5-3.5 2.5-5.6z" />
      <path d="M12 22c5.5 0 10-4.5 10-10H12v3.5h5.6c-1.3 3.5-4.5 5.5-8.6 5.5-5 0-9-4-9-9s4-9 9-9c2.5 0 4.8.9 6.5 2.4l1.9-1.9C17.8 1.1 15 0 12 0 5.4 0 0 5.4 0 12s5.4 12 12 12z" />
    </svg>
  ),
