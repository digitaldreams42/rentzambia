...
export function EscrowManager({ amount, onReleaseFunds, onDispute, status, loading }: EscrowManagerProps) {
  ...
  return (
    <div className="bg-card rounded-lg shadow-md p-6">
      <h2 className="text-xl font-semibold text-foreground mb-4">Payment Protection</h2>
        ...
        {status === "funds_received" && (
          <div className="space-y-3">
            <p className="text-sm text-muted-foreground">
              Your payment is securely held in escrow until both parties confirm the transaction.
            </p>
        ...
        {showDisputeForm && (
          <div className="border rounded-lg p-4">
            ...
            <form onSubmit={handleDisputeSubmit} className="space-y-3">
              <div>
                <label htmlFor="disputeReason" className="block text-sm font-medium mb-1">
                  Reason for dispute
                </label>
                <textarea
                  id="disputeReason"
