    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-8 bg-background">
      <div className="max-w-4xl w-full text-center">
        ...
        <p className="text-xl text-muted-foreground mb-12 max-w-2xl mx-auto">
          RentZambia connects tenants with landlords and agents to make property
          rental simple, fast, and secure.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="bg-card p-6 rounded-lg shadow-md border border-border">
            ...
            <p className="text-muted-foreground mb-4">
              Search thousands of rental properties, schedule visits, and book
              securely.
            </p>
            <Link
              href="/tenant"
          ...
          <div className="bg-card p-6 rounded-lg shadow-md border border-border">
            ...
            <p className="text-muted-foreground mb-4">
              List your properties, manage inquiries, and connect with potential
              tenants.
            </p>
            <Link
              href="/landlord"
          ...
          <div className="bg-card p-6 rounded-lg shadow-md border border-border">
            ...
            <p className="text-muted-foreground mb-4">
              Manage the platform, approve listings, and ensure quality
              standards.
            </p>
            <Link
              href="/admin"
        ...
        <div className="bg-muted rounded-lg p-8 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Schedule visits and secure your rental
              </p>
            </div>
            <div className="text-center">
              <div className="bg-primary text-primary-foreground w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold">
              ...
              <p className="text-muted-foreground">
                Enjoy your new rental with peace of mind
              </p>
            </div>
          </div>
        </div>
