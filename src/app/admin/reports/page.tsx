...
// Mock stats data
const mockStats = [
  { title: "Total Revenue", value: "K124,500", description: "This month's total revenue", trend: "up", trendValue: "+12.5%" },
  { title: "Active Users", value: "1,247", description: "Users active this month", trend: "up", trendValue: "+8.2%" },
  { title: "Properties Listed", value: "342", description: "Total properties on platform", trend: "up", trendValue: "+3.1%" },
  { title: "Bookings Completed", value: "87", description: "Bookings this month", trend: "down", trendValue: "-2.4%" }
];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Reports Section */}
        <div>
          <h3 className="text-xl font-bold text-foreground mb-4">Generated Reports</h3>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {reports.map((report) => (
              <div key={report.id} className="bg-card rounded-lg shadow-md p-6 border border-border">
