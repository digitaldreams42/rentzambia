...
export default function AdminDashboard() {
  ...
  const handleSuspendUser = async (id: number) => {
    try {
      await ApiService.updateUserStatus(id, 'suspended');
      setUsers(prev =>
        prev.map(user =>
  ...
  const handleViewUserDetails = (_id: number) => {
    // In a real implementation, this would redirect to a user details page
  };
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {users.map(user => (
                  <UserCard
                    ...
                    onViewDetails={() => handleViewUserDetails(user.id)}
                  />
                ))}
              </div>
            ) : (
            ...
            <div className="bg-card rounded-lg shadow-md p-6">
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-foreground">
                      New property listing approved: &quot;Modern 2-Bedroom
                      Apartment&quot;
                    </p>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-foreground">
                      New user registration: John Mwanza (Tenant)
                    </p>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-foreground">
                      Property report received for &quot;Luxury Studio&quot;
                    </p>
