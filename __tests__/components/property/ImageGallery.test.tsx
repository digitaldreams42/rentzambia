...
describe('PropertyImageGallery', () => {
  it('renders main image correctly', () => {
    ...
    const mainImage = screen.getAllByAltText('Property image 1')[0];
  ...
  it('passes additional className props', () => {
    render(
      <PropertyImageGallery images={mockImages} className="custom-class" />
    );

    const containers = screen.getAllByAltText('Property image 1');
    const container = containers[0].closest('.border.bg-card');
